...
\begin{longtable}{|c|p{2.5cm}|p{3cm}|p{8cm}|p{4cm}|}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/cicloDesarrollo.png}
	\caption{Ciclo de desarrollo de HelenOS (fuente: \citep{decky2015application}).}
	\label{fig:Ciclo desarrollo de HelenOS}
\end{figure}
...
\begin{longtable}{|p{3.2cm}|p{5cm}|p{1.6cm}|p{2.6cm}|p{4cm}|p{3cm}|}
