...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/comparacionArquitecturas.png}
	\caption{Comparación con arquitecturas clásicas (fuente: \citep{decky2015application}).}
	\label{fig:comparacionArquitecturas}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Interfaz de usuario de HelenOS (fuente: \citep{helenos_wiki_tutorial}).}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/arbolUsers.png}
	\caption{Espacio lógico de usuario en HelenOS (fuente: \citep{decky2015application}).}
	\label{fig:Espacio lógico de usuario en HelenOS}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/arbolDriversHelenOS.jpg}
	\caption{Arbol de drivers de HelenOS (fuente: \citep{decky2015application}).}
	\label{fig:Arbol drivers HelenOS}
\end{figure}
