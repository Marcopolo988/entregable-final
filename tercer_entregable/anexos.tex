...
El mecanismo de comunicación entre procesos (IPC) en HelenOS se basa en el modelo de paso de mensajes mediante ``teléfonos'' (phones) y ``answerboxes''. El flujo típico de una llamada IPC es el siguiente:
